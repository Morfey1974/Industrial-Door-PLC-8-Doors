...
- **❌ "Дергание" двери на SLAVE:** При открытии двери1 на MASTER дверь1 на SLAVE начинает периодически блокироваться-разблокироваться. Подробности в `HANDOFF_DOOR_DERGANYE.md`. Требуется срочное решение.
