    ...
    case 'config-doors':
      return (
        <>
          ...
          <p>Кнопки: «Открыть конфигурацию», «Создать конфигурацию», «Загрузить с контроллера». Блок «Сохраненные конфигурации» — черновик (Загрузить/Сохранить), сохранённые (Загрузить/Удалить).</p>
