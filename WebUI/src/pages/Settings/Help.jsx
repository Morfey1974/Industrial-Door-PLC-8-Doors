...
export const HELP_SECTIONS = [
  ...
  { id: 'config-network', title: 'Конфигурация → Сеть', keywords: 'сеть IP адрес Wi-Fi' },
  { id: 'config-system', title: 'Конфигурация → Параметры системы', keywords: 'система параметры таймауты' },
